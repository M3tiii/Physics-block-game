...
Game = {
  ...
  layout: function(){
    ...
    canvasMenu.addEventListener("touchmove", function(e) {e.preventDefault() }, false);
  ...
  menu: function(){
    ...
    fontSize = V.H/15;
    packs = [ {name:"Can you reach?", colorBack:"#00b9d2", colorFront:"#0099AD", levelComplete:0, enable:true}, 
              {name:"Can you hold?", colorBack:"#E37676", colorFront:"#C26363", levelComplete:0, enable:false}, 
              {name:"Construct bridge", colorBack:"#9C9595", colorFront:"#827C7C", levelComplete:0, enable:false} ];
    actualPack = 0;
    ...
    Events.on(engine, "tick",  function(e){
      ...
      case 0:
        for(var i=0; i<engine.world.bodies.length; i++){
          ...
          if(engine.world.bodies[i].spike){
            //console.log(engine.world.bodies[i])
          }
